...
async def client():
    # Import app fresh for this fixture (env already cleared by calling test)
    app_mod = importlib.reload(sys.modules["main"]) if "main" in sys.modules else importlib.import_module("main")
